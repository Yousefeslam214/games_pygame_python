...
move_rightE2 = [pygame.image.load("enemy/R1E.png"), pygame.image.load("enemy/R2E.png"), pygame.image.load("enemy/R3E.png"), pygame.image.load("enemy/R4E.png"), pygame.image.load("enemy/R5E.png"), pygame.image.load("enemy/R6E.png"), pygame.image.load("enemy/R7E.png"), pygame.image.load("enemy/R8E.png"), pygame.image.load("enemy/R9E.png"), pygame.image.load("enemy/R10E.png"), pygame.image.load("enemy/R11E.png")]
move_leftE2  = [pygame.image.load("enemy/L1E.png"), pygame.image.load("enemy/L2E.png"), pygame.image.load("enemy/L3E.png"), pygame.image.load("enemy/L4E.png"), pygame.image.load("enemy/L5E.png"), pygame.image.load("enemy/L6E.png"), pygame.image.load("enemy/L7E.png"), pygame.image.load("enemy/L8E.png"), pygame.image.load("enemy/L9E.png"), pygame.image.load("enemy/L10E.png"), pygame.image.load("enemy/L10E.png")]
...
#        if self.hitbox[1] < obstacle.y + obstacle.height:
#         if self.hitbox[0] + self.hitbox[2] > obstacle.x and self.hitbox[0] < obstacle.x + obstacle.width:
#             self.vel = self.vel * -1
#             self.walkCount = 0
...
class Obstacle():
       ...
       def draw(self, screen):
              screen.blit(obstacleImg, (self.x, self.y))



man = Player(600, 400, 64, 64)
enemy = Enemy(000, 400, 64, 64, 550)
# enemy = Enemy(1000, 410, 64, 64, 800, move_rightE2, move_leftE2, 5, 15)
font = pygame.font.SysFont("comicsans", 35, True)
obstacle = Obstacle(500, 400, 64, 64)
# # Draw game objects
# enemy.draw(screen)
# enemy.draw(screen)
...
#     enemy.draw(screen)
    ...
    pygame.display.update()
bullets = []
obstacles = [Obstacle(500, 400, 64, 64), Obstacle(200, 300, 64, 64)]
while True:
    ...
    for obstacle in obstacles:
       if obstacle.hitbox[0] < x_mid < obstacle.hitbox[0] + obstacle.hitbox[2]:
        if obstacle.hitbox[1] < y_mid < obstacle.hitbox[1] + obstacle.hitbox[3]:
              score -= 1
              man.hit()
